...
import org.firstinspires.ftc.teamcode.common.utils.util.Encoder;
...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 11.8388667; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -1; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 1.02468647;
    public static double Y_MULTIPLIER = 1.04035822;
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions) {
        ...
        leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "stageOne"));
...
//        lastEncVels.add(frontVel);
        ...
        return Arrays.asList(
                ...
                encoderTicksToInches(frontVel) * X_MULTIPLIER
        );
    }
}
