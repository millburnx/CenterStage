...
//        Mat mat = new Mat();
//        int frameCount = 0;
////        final Rect ROIs = {new Rect(new Point(0, 0), new Point(320, 80)), new Rect(new Point(0, 80), new Point(320, 120)), newRect(new Point(0, 120), new Point(320, 240))};
//
//        @Override
...
//            Mat[] regions;
//            for (int i = 0; i < 3; i++) {
//                regions[i] = input.submat(ROIS[i]);
//            }
//
//            int[] redValues;
//            for (int i = 0; i < 3; i++) {
//                redValues[i] =  (int) Core.sumElems(coneRegion).val[0] / (int) ROIs[i].area();
//            }
//
//            String side;
//            if (redValues[0] > redValues[1] && redVales[0] > redValues[2]) {
//                side = "left";
//            } else if (redValues[1] > redValues[2]) {
//                side = "middle";
//            } else {
//                side = "right";
//            }
//
//            telemetry.addData("The beacon is in the position: ", side);
//
//            for (int i = 0; i < 3; i++) {
//                regions[i].release();
//            }
